...
void main() {
	...
	Vec2 uv = (fragPosition.xz*0.003) + Vec2(g_state.time_passed*0.06) + Vec2(fragPosition.y/50.0) + Vec2(cos(g_state.time_passed+fragPosition.y), sin(g_state.time_passed+fragPosition.y))*0.02;
