# from https://github.com/lsalzman/iqm

# just install as addon in blender 2.93 (should world with 2.90 too)
# edit > export > iqm
# SKELETON HAS TO BE SELECTED
# launch blender from command line for debug info
