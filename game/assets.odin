...
assets_load_persistent :: proc() {
    ...
    cast(rl.ShaderLocationIndex)rl.GetShaderLocation(asset_data.tileShader, "camPos")
    ...
    rl.SetMaterialTexture(
        &asset_data.tileModel.materials[0],
        rl.MaterialMapIndex.ALBEDO,
        asset_data.wallTexture,
    )
    rl.SetMaterialTexture(
        &asset_data.elevatorModel.materials[0],
        rl.MaterialMapIndex.ALBEDO,
        asset_data.elevatorTexture,
    )
